# YOLOv11 Corn Weed Detection System

## Body

The corn weed detection system based on YOLOv11 is a corn seedling weed detection system (YOLOv11+YOLO dataset + UI interface + login registration interface + Python project source code + model).

Class 2,
Names: ["weed", "cron"],
Number of datasets: 2661 training set, 254 validation set, 127 test set.
